...
% Eulerian basic grid
xsize=20000.0;         % size in horizontal direction, m
ysize=5000.0;         % size in vertical direction, m
Nx=81;                % number of grid steps in horizontal directions
Ny=21;                 % number of grid steps in vertical direction
...
% ///////////////////////////////////////////////////////////////////////////////////////
% same loops as above -> possibly merge
% ///////////////////////////////////////////////////////////////////////////////////////
...
for i=1:1:Ny
    for j=1:1:Nx
        ...
        if(ETA(i,j)<ETA0(i,j))
            SIIB=(SXY(i,j)^2+1/2*((SXX(i,j)+SXX(i+1,j)+SXX(i,j+1)+SXX(i+1,j+1))/4)^2+...
...
% ///////////////////////////////////////////////////////////////////////////////////////
% move the next if statement here as only "i" is needed to determine the outcome of
% the statement. If the statement is false there is no need to loop through
% the second loop.
% ///////////////////////////////////////////////////////////////////////////////////////
